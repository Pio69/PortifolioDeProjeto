...
CREATE TABLE `tb_events` (
  ...
  `gene_by_ia` int NOT NULL,
  `device_id` int NOT NULL,
  PRIMARY KEY (`desc`,`device_id`),
  KEY `fk_device` (`device_id`),
  CONSTRAINT `fk_device` FOREIGN KEY (`device_id`) REFERENCES `tb_devices` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
